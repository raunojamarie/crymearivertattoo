      ...
      <div className="black-bacgkround">
        ...
        <p className="centered-absolute-text">
          ...
          <div className="video-wrapper" style={{ position: "relative", zIndex: 0 }}>
            <iframe className="video" src="https://www.youtube.com/embed/HyGDI2nc5Cs?si=3jAuDy4alZ09VgJv&autoplay=1&mute=1" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen>
            </iframe>
          </div>
        </div>
